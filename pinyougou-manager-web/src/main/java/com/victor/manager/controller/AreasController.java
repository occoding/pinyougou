...
import com.victor.pojo.TbAreas;
import com.victor.sellergoods.service.AreasService;
...
public class AreasController {
    ...
    public TbAreas findOne(@RequestParam("id") Integer id) {
    ...
    @ApiImplicitParam(value = "ids", required = true, paramType = "query", allowMultiple = true, dataType = "Integer")
